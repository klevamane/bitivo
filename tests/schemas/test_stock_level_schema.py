"""Tests for stock level schema"""

import pytest
from api.schemas.stock_level import StockLevelSchema
from api.middlewares.base_validator import ValidationError
from tests.mocks.stock_count import STOCK_LEVEL_DATA, STOCK_LEVEL_DATA_INCORRECT


class TestStockLevelSchema:
    """
    Test stock level schema.
    """

    def test_stock_level_schema_with_valid_data_passes(self, init_db):
    ...
    def test_stock_level_schema_with_invalid_name_fails(self, init_db):
